    ...
    <Accordion.Root type="single" collapsible defaultValue="">
      <Accordion.Item value="create-event">
        <Accordion.Header>
          <Accordion.Trigger asChild>
            <Button
              variant="solid"
              size="2"
              className="flex items-center mb-4 bg-emerald-600 hover:bg-emerald-700 text-white"
            >
        ...
        <Accordion.Content className="overflow-hidden">
          <Box className="p-6 bg-white dark:bg-gray-50 rounded-2xl shadow space-y-6">
